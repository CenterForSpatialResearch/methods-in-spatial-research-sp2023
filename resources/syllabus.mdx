...
*Review [projects/precedent examples page](resources/precedents-examples). Pick out two-three examples each week to review thoroughly on your own.*  
...
- This is an interdisciplinary paper with insights about both the history of land use in New York City and new methods for uncovering such histories with GIS. The link between these two aspects of the paper is really key and helpful, I think, as an illustration of how to develop spatial projects. They discuss three different sets of methods about three different urban land use phenomena. If you don't have time to read the full article piece read the introduction, Sources and Methods, and Land Use Within Blocks.

Center for Spatial Research & Department of History, Columbia University, [*Mapping Historical New York, A Digital Atlas*](https://mappinghny.com/case-studies?caseStudyId&caseStudyStep&lng=-73.9760&lat=40.7220&zoom=12.50&maps=%5B%7B%22center%22%3A%7B%22lat%22%3A40.722,%22lng%22%3A-73.976%7D,%22demographicOpacity%22%3A1,%22demographicsFilters%22%3A%7B%7D,%22filters%22%3A%7B%7D,%22layers%22%3A%5B%7B%22id%22%3A%22dwellings-dot-density-birthplace%22%7D%5D,%22rasterOpacity%22%3A1,%22year%22%3A%221880%22,%22zoom%22%3A12.5%7D%5D&rasterOpacity0=1). 2021. 

- Please read the 'Intro to Historical NY` story at the link above, and click through to each stage of this introduction to the project through 173 Douglas Street. Feel free to further explore the interactive map.
...
### In class: [Precedents on Mural](https://app.mural.co/t/a44073407/m/a44073407/1644513103910/9ff46a25eef18437765d0962198c63cc18f2148e?sender=u506240c4b1153e9cfffb2652)
